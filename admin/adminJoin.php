...
<body>
    ...
    <main id="main">
        <sesction id="join" class="container admin">
            <h2>관리자 회원 가입</h2>
                    ...
                    <fieldset>
                        ...
                        <div class="join__box">
                            ...
                            <div>
                                ...
                                <input type="text" id="youName" name="youName" maxlength="5" placeholder="이름을 입력하세요." required>
                                <p class="msg" id="youNameComment"><!-- * 이름은 한글로만 작성이 가능합니다.--></p>
                            </div>
                            
                            <div>
                                <label for="youPass">비밀번호</label>
                                <input type="password" id="youPass" name="youPass" maxlength="20" placeholder="비밀번호를 입력하세요." required>
                                <p class="msg" id="youPassComment"><!-- * 비밀번호는 특수기호, 숫자가 포함되어야 합니다.--></p>
                            </div>
                            <div>
                                <label for="youPassC">비밀번호 확인</label>
                                <input type="password" id="youPassC" name="youPassC" placeholder="비밀번호를 입력하세요."
                                    required>
                            ...
                            <div>
                                ...
                                <input
                                 type="text" id="youBirth" name="youBirth" placeholder="YYYY-MM-DD" maxlength="15" required>
                                 <p class="msg" id="youBirthComment"><!-- * 생년월일이 일치하지 않습니다.--></p>
                            </div>
                            <div>
                                <label for="youPhone">전화번호</label>
                                <input
                                 type="text" id="youPhone" name="youPhone" placeholder="000-0000-0000" maxlength="15" required>
